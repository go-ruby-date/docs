...
Contributions are welcome. `go-ruby-date/date` is built to a small set of non-negotiable
...
The library is in
[`github.com/go-ruby-date/date`](https://github.com/go-ruby-date/date). This documentation site is in
[`github.com/go-ruby-date/docs`](https://github.com/go-ruby-date/docs). Start from the
